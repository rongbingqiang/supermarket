...
import com.rong.enums.wxpay.WxApiType;
import com.rong.enums.wxpay.WxNotifyType;
import com.rong.enums.wxpay.WxRefundStatus;
import com.rong.enums.wxpay.WxTradeState;
...
public class WxPayServiceImpl implements WxPayService {
    ...
    @Override
    public Map<String, Object> nativePay(Integer oid) throws Exception {

        log.info("生成订单");

        //生成订单
//        OrderInfo orderInfo = orderInfoService.createOrderByProductId(productId);
        Order orderInfo = orderService.getById(oid);
