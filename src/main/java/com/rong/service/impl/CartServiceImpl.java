...
import com.rong.entity.Cart;
import com.rong.entity.Product;
import com.rong.mapper.CartMapper;
import com.rong.service.ICartService;
import com.rong.service.IProductService;
import com.rong.service.ex.AccessDeniedException;
import com.rong.service.ex.CartNotFoundException;
...
public class CartServiceImpl implements ICartService {
    ...
    public List<CartVO> getVOByCids(Integer uid, Integer[] cids) {
		...
		*/
		list.stream().filter( o -> o.getUid().equals(uid));
...
//        }
    ...
    @Override
    public void deleteByUidAndCid(Integer uid, Integer pid){
        cartMapper.deleteByUidAndCid( uid,  pid);
    }
}
